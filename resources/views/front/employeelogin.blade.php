...
<div id="single-wrapper">
	<form action="/employeeloginaction" class="frm-single" method="POST">
        @csrf
		<div class="inside">
			<div class="title"><strong>AppraiseME</strong></div>
			<!-- /.title -->
			<div class="frm-title">Employee Login</div>
			...
			<div class="clearfix margin-bottom-20">
				...
				<!-- /.float-left -->
				<div class="float-right"><a href="/forgot" class="a-link"><i class="fa fa-unlock-alt"></i>Forgot password?</a></div>
				<!-- /.float-right -->
			</div>
			<!-- /.clearfix -->
